...
/*******************************************
 * 本JS檔存放位置由 WFU BLOG 提供
 * JS檔主程式出自台灣PHP聯盟：http://twpug.net/modules/newbb/viewtopic.php?viewmode=flat&topic_id=1091&forum=21&type=
 * 字庫出自：http://blog.csdn.net/johnsuna/article/details/2643294
 *
 * 由 WFU BLOG 修改、精簡 並擴增字庫
 * 欲編輯、修改本程式，記得儲存的格式要選 unicode。
 *
 * WFU Blog : http://wayne-fu.blogspot.com/
 ***********************************/
